...
public class GUI extends PApplet {
    ...
    public void setup() {
        ...
        controlP5.addSlider("extrudeDistance").setPosition(40, 60).setSize(200, 20).setRange(0, 100).setValue(1).setColorCaptionLabel(color(20,20,20));
        controlP5.addSlider("vertexExpandDistance").setPosition(40, 80).setSize(200, 20).setRange(0, 100).setValue(1).setColorCaptionLabel(color(20,20,20));
        controlP5.addSlider("chamferCornersDistance").setPosition(40, 100).setSize(200, 20).setRange(0, 30).setValue(1).setColorCaptionLabel(color(20,20,20));
        ...
        controlP5.addSlider("wireFrameOffset").setPosition(40, 160).setSize(200, 20).setRange(0, 100).setValue(1).setColorCaptionLabel(color(20,20,20));
        controlP5.addSlider("smoothIterations").setPosition(40, 180).setSize(200, 20).setRange(0, 10).setValue(1).setColorCaptionLabel(color(20,20,20));
